...
import { Star, Shield, Award, Sparkles, Crown } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg"
                className="group relative bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 hover:from-amber-700 hover:via-yellow-600 hover:to-amber-700 text-white shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-110 px-10 py-6 rounded-2xl font-semibold overflow-hidden border-2 border-yellow-400/30"
              ...
              >
                ...
                {/* Golden particles */}
                <div className="absolute top-2 left-4 w-1 h-1 bg-yellow-200 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping"></div>
                <div className="absolute bottom-2 right-4 w-1 h-1 bg-yellow-200 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping animation-delay-300"></div>
              ...
              <Button 
                size="lg"
                variant="outline"
                className="group relative border-3 border-amber-600 text-amber-700 hover:text-white shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-110 px-10 py-6 rounded-2xl font-semibold overflow-hidden bg-white/80 backdrop-blur-sm"
                onClick={() => document.getElementById('booking-section')?.scrollIntoView({ behavior: 'smooth' })}
              >
                {/* Golden fill animation */}
                <div className="absolute inset-0 bg-gradient-to-r from-amber-600 to-yellow-600 scale-0 group-hover:scale-100 transition-transform duration-500 origin-center rounded-2xl"></div>
